...
load_par("1H0707_comb_fmax_best_fit.par");
%Label_By_Default = 0;
...
%emcee(200, 10000; output="1H0707_comb_fmax_chain.fits", serial);
...
variable pid = open_plot("1H0707_comb_fmax_walkers.ps/cps");
...
frac_update = read_chain("1H0707_comb_fmax_chain.fits"; frac_update);
...
variable pid = open_plot("1H0707_comb_fmax_mass_accept_rate.ps/cps");
charsize(1.3); %good font size
_pgscf(2); %make font roman
xlabel("Iteration Step");
ylabel("Acceptance Rate");
...
variable pid = open_plot("1H0707_comb_fmax_norm_prob.ps/cps");
charsize(1.3); %good font size
_pgscf(2); %make font roman
...
variable pid = open_plot("1H0707_comb_fmax_mass_prob.ps/cps");
charsize(1.3); %good font size
_pgscf(2); %make font roman
...
chain_hist2d(1, 0, chain; nbinx = 200, nbiny = 200, xlo = 6.1, xhi = 6.5, ylo = 1.5e-5, yhi = 4.5e-5);
close_plot;
%Make good image of the Contours
variable pid = open_plot("1H0707_comb_fmax_chain_hist2d.ps/cps");
_pgscf(2); %make font roman
...
variable pid = open_plot("1H0707_comb_fmax_statistics.ps/cps");
charsize(1.3); %good font size
_pgscf(2); %make font roman
...
variable pid = open_plot("1H0707_comb_fmax_logmass.ps/cps");
_pgscf(2); 
